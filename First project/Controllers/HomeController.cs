...
namespace First_project.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var chefs = await _context.Users.Include(r => r.Role).Where(r => r.Role.RoleId == 2).ToListAsync();
        ...
        public async Task<IActionResult> Purchase(decimal? recipeId, Visainfo visainfo)
        {
            ...
            // && because all data should be Identical.
             VisaChecher visaCHecker = await _context.VisaChechers.FirstOrDefaultAsync();
